...
<div class="row">
    ...
    <div class="col-lg-3 col-md-6" id="dashboard-active-listing-tile">
        <div class="dashboard-stat color-1">
            <div class="dashboard-stat-content"><h4><?php echo wp_kses_post( wc_price( $earning ) ); ?></h4> <span><?php esc_html_e('Sales','listeo_core'); ?></span></div>
...
<g>
    ...
    <div class="col-lg-3 col-md-6"  id="dashboard-stat-listing-tile">
        <div class="dashboard-stat color-2" >
            <div class="dashboard-stat-content"><h4><?php echo wp_kses_post( dokan_get_seller_earnings( dokan_get_current_user_id() ) ); ?></h4> <span><?php esc_html_e('Earning','listeo_core'); ?></span></div>
            <div class="dashboard-stat-icon">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g>
    ...
    <div class="col-lg-3 col-md-6" id="dashboard-reviews-listing-tile">
        <div class="dashboard-stat color-3" >
            <div class="dashboard-stat-content"><h4><?php echo esc_html( dokan_number_format( esc_attr( $pageviews ) ) ); ?></h4> <span><?php esc_html_e('Pageviews','listeo_core'); ?></span></div>
    ...
    <div class="col-lg-3 col-md-6"  id="dashboard-bookmarks-listing-tile">
        <div class="dashboard-stat color-4">
            <div class="dashboard-stat-content"><h4><?php
                ...
                ?></h4> <span><?php esc_html_e('Order','listeo_core') ?></span></div>
            <div class="dashboard-stat-icon">
