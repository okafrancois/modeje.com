									...
									if (taxonomy_exists($taxonomy)) {
										...
										if ($term_id && !empty($term['meta']) && is_array($term['meta'])) {
											foreach ($term['meta'] as $meta_key => $meta_val) {
												...
												listeo_write_log('meta-key');
												listeo_write_log($meta_key);
												listeo_write_log('meta-val');
												listeo_write_log($meta_val);
												$meta_val      = maybe_unserialize($meta_val);
												listeo_write_log('meta-unserilized val:');
												listeo_write_log($meta_val);
		...
		?>
			...
			<div class="envato-setup-next-steps">
				<div class="envato-setup-next-steps-first">
					...
					<ul>
						<li class="setup-product"><a class="button button-primary button-large" href="https://twitter.com/purethemes" target="_blank"><?php esc_html_e('Follow @purethemes on Twitter', 'listeo'); ?></a>
						</li>
