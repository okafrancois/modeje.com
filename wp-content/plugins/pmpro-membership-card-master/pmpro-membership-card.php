...
function pmpro_membership_card_get_full_name($user) {
...
/**
 * Returns the member's avatar image url
 */

function pmpro_membership_card_return_avatar_url( $pmpro_membership_card_user ){
        $avatar_url = get_avatar_url( $pmpro_membership_card_user->ID, array( 'size' => 400 ) );
        return $avatar_url;
}
